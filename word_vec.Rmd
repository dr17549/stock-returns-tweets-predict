...
filtered_data <- combined_df[str_detect(combined_df$tweet, "thank you"), ]
head(filtered_data[, c('tweet', 'test_predict','test_Y')])


# Plotting the histogram of values 
hist(train_Y, main = 'Histogram of Outcomes', xlab = 'Values', ylab = 'Frequency', col = 'lightblue', border = 'black')
...
# kendall_acc(test_predict_binary,non_faang$made_money)
